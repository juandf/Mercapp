...
import static com.android.store.mercapp.R.drawable.ic_circlered;

public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,FragmentStorage.OnFragmentInteractionListener,ExampleDialog.DialogListener{
    FirebaseAuth mAuth;
            ...
            public void onClick(View view) {
                switch (optionSelected){
                    case 1:
                        ...
                        break;
                    case 2:
                        /*oast.makeText(getApplicationContext(), "PRODUCTOS", Toast.LENGTH_SHORT).show();
                        Intent intentP = new Intent(getApplicationContext(),RegistrarProductos.class);
    ...
    @Override
    public void RegisterStore(String Nombre, String Direccion, String Estado) {
        ...
        Storage storage = new Storage(Nombre,Direccion,Estado);
        FirebaseFirestore.getInstance().collection("Tiendas").document().set(storage).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
